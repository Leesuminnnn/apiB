...
//	alert("테스트입니다.")
	...
	//가상경로 사용
	fm.action = "<%=request.getContextPath()%>/board2/iqyModifyAction.do2";
	fm.method = "post";
	fm.submit();
	...
	<form name="frm">
		<table border=1 class="content">
			<tr>
				...
				<td style="padding-left: 10px;"><input type="text" name="subject" value="<%=iv.getSubject() %>"></td>
			</tr>
			<tr>
				<td>내용</td>
				<td style="padding: 10px;"><textarea name="content" placeholder="내 용"><%=iv.getContent() %></textarea></td>
			</tr>
			<tr>
